// ข้อมูล Mock User สำหรับทดสอบในโหมดพัฒนา
const MOCK_USER = {
  ...
  idToken:
    "eyJraWQiOiIyNmNmMzk1ZjQ4MTYyZTRhMzc3MzM5Yjk1MjBjNzA2NzI5ZTFmZGMzYTY0NWI3YTlhZTc3YWMyYTQ4NzVhODA4IiwidHlwIjoiSldUIiwiYWxnIjoiRVMyNTYifQ..MmbZtzrSCGmbib-o-MqA1OK9q7-GW7VvYYb5EYDsK4D2EXQknyGEPQGu6I4hO5pwveXWYIhSWwX7mHm3d2XRMg",
};

// ทดสอบ LIFF Login
export function TEST_useLiffAuth() {
  return { users: MOCK_USER, loading: false, error: null };
}
